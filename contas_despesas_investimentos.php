	...
	<div class="container-fluid conteudo_home">
		...
		<div class="row row-down">
			...
			<div class="col-md-12 border_custom">
				...
				<br>
					<div class="col-md-3">						
						<form class="input-group form_procurar_notas">
		                    <input type="text" id="nome_conta_despesa_investimento" class="form-control" placeholder="Nome Conta" maxlength="140" name="nome_conta_despesa_investimento">
		                    <select  id="natureza_conta" class="form-select" name="natureza_conta"> 
