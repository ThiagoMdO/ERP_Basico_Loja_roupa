...
<?php
	...
	if($resultado_pesquisa_id){
		$i = 1;
		echo '	<div class="none">
					<input id="saldo_dinheiro" name="saldo_dinheiro" value="'.$saldo_dinheiro.'">
					<input id="saldo_banco" name="saldo_banco" value="'.$saldo_banco.'">
				</div>';
		while($linha = mysqli_fetch_array($resultado_pesquisa_id, MYSQLI_ASSOC)){
			$imagem;
			switch($linha["nome_produto"]){
...
>>>>>>> 6e9b4a8f5b21e9f615688481b07aae2683cdc682
?>