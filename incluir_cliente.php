<?php 
	...
	if($resultado_id_existe){
		...
		if($linha = mysqli_fetch_array($resultado_id_existe)){
			...
			$sql_inserir_cliente = "INSERT INTO clientes (nome_cliente,cpf,contato_telefone,rua,numero,bairro,cidade,uf,ceep) VALUES ('$novo_cliente_nome','$novo_cliente_cpf','$novo_cliente_telefone','$novo_cliente_rua','$novo_cliente_numero_casa','$novo_cliente_bairro','$novo_cliente_cidade','$novo_cliente_uf','$novo_cliente_ceep')";
